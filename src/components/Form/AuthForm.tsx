...
const AuthForm: React.FC<AuthFormProps> = ({
  ...
  if (isLogin) linkBelowForm = { text: "Don't have an account? Register", href: "/register" }
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-300 leading-relaxed max-w-md">
              {heroSubtitle || "Plan family dinners, calculate costs, and organize meals together with ease."}
            </p>
          </div>
        </div>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            {isLogin && (
              <div className="flex items-center justify-between pt-2">
                ...
                <Link href="/forgot-password" className="text-sm text-slate-600 hover:text-slate-900 transition">
                  Forgot password?
                </Link>
              </div>
            )}
